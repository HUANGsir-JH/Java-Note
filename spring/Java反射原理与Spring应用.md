...
**反射是 Java 在运行状态中，对于任意一个类，都能够知道这个类的所有属性和方法；对于任意一个对象，都能够调用它的任意方法和属性。** 如果说 Java 代码是“死”的，反射就赋予了 Java 在运行时“自我观察”和“动态修改”的能力。它是从“静态编译”走向“动态扩展”的桥梁。
...
**面试建议：** 回答此问题时，一定要把反射和 **“动态性”** 联系起来。可以多提一句：“反射让 Spring 实现了**配置化**，让框架不再关心具体的类名，只关心规则。”
